  ...
  return (
    <section className="flex flex-col items-center justify-center text-center py-16 px-4 bg-white">
      <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">
        BE A PART OF OUR{" "}
        <span className="text-yellow-600">GOLD REVOLUTION!</span>
      </h2>
      ...
      <button className="mt-6 bg-yellow-600 hover:bg-yellow-700 text-white font-semibold py-2 px-6 rounded-full shadow-md transition duration-300"
